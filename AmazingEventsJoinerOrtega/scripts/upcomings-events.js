...
//     ],
//   };
//   const containerIndex = document.querySelector("#divUpcomingsEvents")
...
//   document.querySelectorAll('#divUpcomingsEvents .card').forEach(card => {
...
//   const cards = document.querySelectorAll('#divUpcomingsEvents .card');
//   let found = false;
