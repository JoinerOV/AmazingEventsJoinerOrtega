...
//                 <a href="./pages/details.html?id=${data.events[i]._id}" class="btn btn-primary">Details</a>
//             </div>
//         </div>
//     </div> ` 
...
// //   document.querySelectorAll('#containerIndex .card').forEach(card => {
...
// // // //   const cards = document.querySelectorAll('#containerIndex .card');
// // // //   let found = false;
...
// // //   if (query.trim() === '') {
// // //       cards.forEach(card => {
// // //           card.style.display = 'block';  // Mostrar todas las cards
// // //       });
// // //       document.querySelector('#noSeEncontroMensaje').style.display = 'none';
// // //       return;
// // //   }
...
// // //   const noSeEncontroMensaje = document.querySelector('#noSeEncontroMensaje');
// // //   noSeEncontroMensaje.style.display = found ? 'none' : 'block';
// // // }
// // // function filterEvents() {
// // //   const selectedCategories = Array.from(document.querySelectorAll('.form-check-input:checked'))
// // //       .map(checkbox => checkbox.value);
...
// // //   // Mostrar todas las cards si no hay texto y no hay categorías seleccionadas
...
// // // // Event listener para mostrar todas las cards si el campo de búsqueda está vacío
// // // document.querySelector('input.form-control').addEventListener('input', () => {
// // //   const query = normalizeText(document.querySelector('input.form-control').value);
// // //   if (query.trim() === '') {
// // //       searchEvents();  // Muestra todas las cards si el campo está vacío
// // //   }
// // // });
...
// // Crear tarjetas usando la función del primer código
...
//     card.innerHTML = `
//       <div class="card">
//         <img class="card-img-top p-2" src="${evento.image}" alt="${evento.name}">
//         <div class="card-body">
...
// // Crear filtros de categoría de forma dinámica
// function createCategoryFilters(categories) {
//   const filterContainer = document.getElementById("category");

//   categories.forEach((category) => {
//     const filterDiv = document.createElement("div");
//     filterDiv.classList = "form-check pt-3 mb-3";
//     filterDiv.innerHTML = `
//       <div class="form-check">
//         <input type="checkbox" class="form-check-input" value="${category}" id="category-${category}" />
...
// // Añadir listener a los checkboxes de categorías y al botón de búsqueda
...
//   // Crear tarjetas con los resultados filtrados
//   crearCard(filteredArray);
// }

// // Filtrar por búsqueda en nombre y descripción de los eventos
